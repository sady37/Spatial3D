...
| M | 内容 | 状态 |
|---|---|---|
| **M1** | 双振荡器 EKF(呼吸不对称波形 + 心搏 JKL 相位振荡器 + 卡尔曼平滑),**tachy2 单bin**起步 → 能否平滑跟出 131→91 | **brief 已写:`pc/M1_joint_ekf_brief.md`**(新会话贴此) |
| M2 | 从数据学 g_R / g_JKL 波形模板(替换手设) | 待 |
...
新会话从 M1 起,读 `pc/M1_joint_ekf_brief.md`(自包含)。
