...
def _reset_state():
    ...
    srv._cube_result.update(rr=None, strength=0.0, t=0.0, floor_frac=0.0, bin=None, resp_bin=None, epoch=None)
    srv._cube_query_epoch[0] = 0
    srv._floor_pts = []
    ...
    srv._cube_neg_run[0] = 0; srv._cube_eval_t[0] = 0.0
    srv._recover_since[0] = 0.0; srv._last_low_xy[0] = None
